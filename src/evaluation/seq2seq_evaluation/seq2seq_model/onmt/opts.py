...
def model_opts(parser):
    ...
    # Embedding Options
    group = parser.add_argument_group('ClassifierModel-Embeddings')
    ...
    group = parser.add_argument_group('ClassifierModel-Embedding Features')
    ...
    group = parser.add_argument_group('ClassifierModel- Encoder-Decoder')
    ...
    # Attention options
    group = parser.add_argument_group('ClassifierModel- Attention')
...
def train_opts(parser):
    ...
    group.add('--save_model', '-save_model', default='model',
              help="ClassifierModel filename (the model will be saved as "
...
def translate_opts(parser):
    ...
    group = parser.add_argument_group('ClassifierModel')
